...
class Bullet1(pygame.sprite.Sprite):
    def __init__(self, rectition):
        ...
        self.image = pygame.image.load("Airplane-Battle-Game-master/image/bullet1.png")
...
class Bullet2(pygame.sprite.Sprite):
    def __init__(self, rectition):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load("Airplane-Battle-Game-master/image/bullet2.png")
        self.rect = self.image.get_rect()
        self.rect.left, self.rect.top = rectition
        self.speed = 18
        self.active = True
...
class Player(pygame.sprite.Sprite):
    def __init__(self,bg_size):
        ...
        self.image1 = pygame.image.load("Airplane-Battle-Game-master/image/hero1.png")
        self.image2 = pygame.image.load("Airplane-Battle-Game-master/image/hero2.png")
        # 获取飞机图像的掩膜用以更加精确的碰撞检测
        self.mask = pygame.mask.from_surface(self.image1)
        #飞机坏掉的图片
        self.destroy_images = []
        self.destroy_images.extend([pygame.image.load("Airplane-Battle-Game-master/image/hero_blowup_n1.png"),
                                    pygame.image.load("Airplane-Battle-Game-master/image/hero_blowup_n2.png"),
                                    pygame.image.load("Airplane-Battle-Game-master/image/hero_blowup_n3.png"),
                                    pygame.image.load("Airplane-Battle-Game-master/image/hero_blowup_n4.png")])
        #得到飞机的位置
...
class SmallEnemy(pygame.sprite.Sprite):
    def __init__(self,bg_size):
        ...
        self.image = pygame.image.load("Airplane-Battle-Game-master/image/enemy1.png")
        self.mask = pygame.mask.from_surface(self.image)
        self.destroy_images = []
        self.destroy_images.extend([pygame.image.load("Airplane-Battle-Game-master/image/enemy1_down1.png"),
                                    pygame.image.load("Airplane-Battle-Game-master/image/enemy1_down2.png"),
                                    pygame.image.load("Airplane-Battle-Game-master/image/enemy1_down3.png"),
                                    pygame.image.load("Airplane-Battle-Game-master/image/enemy1_down4.png")])
        self.rect = self.image.get_rect()
        self.width, self.height = bg_size[0],bg_size[1]
        self.speed = 4
...
class MidEnemy(pygame.sprite.Sprite):
    ...
    def __init__(self,bg_size):
        ...
        self.image = pygame.image.load("Airplane-Battle-Game-master/image/enemy2.png")
        self.mask = pygame.mask.from_surface(self.image)
        self.destroy_images = []
        self.destroy_images.extend([pygame.image.load("Airplane-Battle-Game-master/image/enemy2_down1.png"),
                                    pygame.image.load("Airplane-Battle-Game-master/image/enemy2_down2.png"),
                                    pygame.image.load("Airplane-Battle-Game-master/image/enemy2_down3.png"),
                                    pygame.image.load("Airplane-Battle-Game-master/image/enemy2_down4.png")])
        self.image_hit = pygame.image.load("Airplane-Battle-Game-master/image/enemy2_hit.png")
        self.rect = self.image.get_rect()
        self.width, self.height = bg_size[0],bg_size[1]
        self.speed = 2
...
class BigEnemy(pygame.sprite.Sprite):
    ...
    def __init__(self,bg_size):
        ...
        self.image1 = pygame.image.load("Airplane-Battle-Game-master/image/enemy3_n1.png")
        self.image2 = pygame.image.load("Airplane-Battle-Game-master/image/enemy3_n2.png")
        self.mask = pygame.mask.from_surface(self.image1)
        self.destroy_images = []
        self.destroy_images.extend([pygame.image.load("Airplane-Battle-Game-master/image/enemy3_down1.png"),
                                    pygame.image.load("Airplane-Battle-Game-master/image/enemy3_down2.png"),
                                    pygame.image.load("Airplane-Battle-Game-master/image/enemy3_down3.png"),
                                    pygame.image.load("Airplane-Battle-Game-master/image/enemy3_down4.png"),
                                    pygame.image.load("Airplane-Battle-Game-master/image/enemy3_down5.png"),
                                    pygame.image.load("Airplane-Battle-Game-master/image/enemy3_down6.png")])
        self.rect = self.image1.get_rect()
        self.width, self.height = bg_size[0],bg_size[1]
        self.speed = 2
        ...
        self.image_hit = pygame.image.load("Airplane-Battle-Game-master/image/enemy3_hit.png")
        self.hit = False
    #定义敌机的移动函数
    def move(self):
        if self.rect.top >= self.height - 60:
...
class BulletSupply(pygame.sprite.Sprite):
    def __init__(self,bg_size):
        ...
        self.image = pygame.image.load("Airplane-Battle-Game-master/image/ufo1.png")
        self.rect = self.image.get_rect()
...
class BombSupply(pygame.sprite.Sprite):
    def __init__(self,bg_size):
        ...
        self.image = pygame.image.load("Airplane-Battle-Game-master/image/ufo2.png")
        self.rect = self.image.get_rect()
        self.rect.left, self.rect.bottom = random.randint(0, screenwidth - self.rect.width),-100
        self.speed = 5
        self.active = False
...
# =======================载入游戏音乐===============
#背景音乐
pygame.mixer.music.load("Airplane-Battle-Game-master/sound/game_music.wav")
pygame.mixer.music.set_volume(0.1)
#子弹声音
bullet_sound = pygame.mixer.Sound("Airplane-Battle-Game-master/sound/bullet.wav")
bullet_sound.set_volume(0.2)
#boss飞来的声音
big_enemy_flying_sound = pygame.mixer.Sound("Airplane-Battle-Game-master/sound/big_spaceship_flying.wav")
big_enemy_flying_sound.set_volume(0.4)
#敌人1死掉的声音
enemy1_killed_sound = pygame.mixer.Sound("Airplane-Battle-Game-master/sound/enemy1_down.wav")
enemy1_killed_sound.set_volume(0.2)
#敌人2死掉的声音
enemy2_killed_sound = pygame.mixer.Sound("Airplane-Battle-Game-master/sound/enemy2_down.wav")
enemy2_killed_sound.set_volume(0.2)
#大boss死掉的声音
enemy3_killed_sound = pygame.mixer.Sound("Airplane-Battle-Game-master/sound/enemy3_down.wav")
enemy3_killed_sound.set_volume(0.2)
#自己死掉的声音
me_killed_sound = pygame.mixer.Sound("Airplane-Battle-Game-master/sound/game_over.wav")
me_killed_sound.set_volume(0.2)
#按钮按下的声音
button_down_sound = pygame.mixer.Sound("Airplane-Battle-Game-master/sound/button.wav")
button_down_sound.set_volume(0.2)
#升级的声音
level_up_sound = pygame.mixer.Sound("Airplane-Battle-Game-master/sound/achievement.wav")
level_up_sound.set_volume(0.2)
#爆炸的声音
bomb_sound = pygame.mixer.Sound("Airplane-Battle-Game-master/sound/use_bomb.wav")
bomb_sound.set_volume(0.2)
#获得生命的声音
get_bomb_sound = pygame.mixer.Sound("Airplane-Battle-Game-master/sound/get_bomb.wav")
get_bomb_sound.set_volume(0.2)
#获得子弹的声音
get_bullet_sound = pygame.mixer.Sound("Airplane-Battle-Game-master/sound/get_double_laser.wav")
...
def showStartScreen():
    ...
    #加载刚开始的图
    begin_image1 = pygame.image.load("Airplane-Battle-Game-master/image/background.png")
    begin_image2 = pygame.image.load("Airplane-Battle-Game-master/image/text.png")
    begin_image3 = pygame.image.load("Airplane-Battle-Game-master/image/button.png")
    begin_loads = []
    begin_loads.extend([pygame.image.load("Airplane-Battle-Game-master/image/game_loading1.png"),
                        pygame.image.load("Airplane-Battle-Game-master/image/game_loading2.png"),
                        pygame.image.load("Airplane-Battle-Game-master/image/game_loading3.png")])
    begin_index = 0
...
def gameBeigin(running):
    clock = pygame.time.Clock()
    #载入背景图
    background_img = pygame.image.load("Airplane-Battle-Game-master/image/background.png").convert()
    #载入游戏结束图
    gameover_img = pygame.image.load("Airplane-Battle-Game-master/image/gameover.png").convert()
    gameover_rect = gameover_img.get_rect()
    #载入重新开始游戏图
    back_to_game_image = pygame.image.load("Airplane-Battle-Game-master/image/game_again.png").convert_alpha()
    ...
    paused = False
    #加载暂停相关的按钮
    pause_nor_image = pygame.image.load("Airplane-Battle-Game-master/image/game_pause_nor.png")
    pause_pressed_image = pygame.image.load("Airplane-Battle-Game-master/image/game_pause_pressed.png")
    resume_nor_image = pygame.image.load("Airplane-Battle-Game-master/image/game_resume_nor.png")
    resume_pressed_image = pygame.image.load("Airplane-Battle-Game-master/image/game_resume_pressed.png")
    ...
    #加载全屏炸弹图标
    bomb_img = pygame.image.load("Airplane-Battle-Game-master/image/bomb.png")
    ...
    #游戏难度级别
    level = 1
    life_img = pygame.image.load("Airplane-Battle-Game-master/image/life.png").convert()
